...
class Application:
    def __init__(self, root):
        ...
        link_label = Label(self.root,text="Please Paste any Youtube Video Link below", font=('showpersons', 30))
        ...
        self.downloadButton = Button(self.root,text="Download", width=18, font=("Bell MT",15),command=self.checkyoutubelink)
